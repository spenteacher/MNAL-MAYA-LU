...
\subsection{ Comparación LU vs Eliminación Gaussiana \cite{strang2016introduction} \cite{libretextsGauss}}
...
\section{ Modelado Matemático del Sistema Físico \cite{hibbeler2016engineering} \cite{serway2014physics}}
...
\section{  Implementación Computacional \cite{numpyDoc} \cite{scipyLU} \cite{matplotlibDoc}}
...
\section{\cite{zienkiewicz2013finite}}
